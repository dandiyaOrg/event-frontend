  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-50 backdrop-blur-sm">
      <form
        ...
        className="bg-white rounded-lg p-6 w-96 shadow-2xl relative max-h-[90vh] overflow-y-auto"
      >
        ...
        {newUser ? (
          <>
            ...
            <input
              ...
              className={`w-full mb-3 px-3 py-2 border rounded focus:outline-none focus:ring-2 ${
                errors.country ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-green-500"
              }`}
            />
            ...
            <input
              ...
              className={`w-full mb-3 px-3 py-2 border rounded focus:outline-none focus:ring-2 ${
                errors.birthday ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-green-500"
              }`}
            />
            ...
            <input
              ...
              className={`w-full mb-3 px-3 py-2 border rounded focus:outline-none focus:ring-2 ${
                errors.occupation ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-green-500"
              }`}
            />
            ...
            <input
              ...
              className={`w-full mb-3 px-3 py-2 border rounded focus:outline-none focus:ring-2 ${
                errors.mobile ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-green-500"
              }`}
            />
